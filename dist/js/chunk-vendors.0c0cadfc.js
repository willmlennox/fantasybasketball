 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kr{On(t){this.Mn=t}getDocumentsMatchingQuery(t,e,n,r){return function(t){return 0===t.filters.length&&null===t.limit&&null==t.startAt&&null==t.endAt&&(0===t.explicitOrderBy.length||1===t.explicitOrderBy.length&&t.explicitOrderBy[0].field.isKeyField())}(e)||n.isEqual(P.min())?this.Fn(t,e):this.Mn.vn(t,r).next(i=>{const o=this.Ln(e,i);return(zt(e)||Ht(e))&&this.Bn(e.limitType,o,r,n)?this.Fn(t,e):(f()<=s["a"].DEBUG&&d("QueryEngine","Re-using previous result from %s to execute query: %s",n.toString(),ee(e)),this.Mn.getDocumentsMatchingQuery(t,e,n).next(t=>(o.forEach(e=>{t=t.insert(e.key,e)}),t)))})}Ln(t,e){let n=new ze(re(t));return e.forEach((e,r)=>{ne(t,r)&&(n=n.add(r))}),n}Bn(t,e,n,r){if(n.size!==e.size)return!0;const i="F"===t?e.last():e.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Fn(t,e){return f()<=s["a"].DEBUG&&d("QueryEngine","Using full collection scan to execute query:",ee(e)),this.Mn.getDocumentsMatchingQuery(t,e,P.min())}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ao{constructor(t){this._byteString=t}static fromBase64String(t){try{return new ao(z.fromBase64String(t))}catch(t){throw new _(w.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(t){return new ao(z.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function ta(t){t=zs(t,Js);const e=zs(t.firestore,no);return Ls(io(e),t._key).then(n=>aa(e,t,n))}class ea extends Yo{constructor(t){super(),this.firestore=t}convertBytes(t){return new ao(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Js(this.firestore,null,e)}}function na(t){t=zs(t,Qs);const e=zs(t.firestore,no),n=io(e),r=new ea(e);return Vo(t._query),Ps(n,t._query).then(n=>new Fo(e,r,t,n))}function ra(t,e,n){t=zs(t,Js);const r=zs(t.firestore,no),i=Zo(t.converter,e,n);return oa(r,[yo(vo(r),"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,Ee.none())])}function ia(t,e,n,...r){t=zs(t,Js);const i=zs(t.firestore,no),s=vo(i);let a;return a="string"==typeof(e=Object(o["i"])(e))||e instanceof oo?_o(s,"updateDoc",t._key,e,n,r):wo(s,"updateDoc",t._key,e),oa(i,[a.toMutation(t._key,Ee.exists(!0))])}function sa(t,...e){var n,r,i;t=Object(o["i"])(t);let s={includeMetadataChanges:!1},a=0;"object"!=typeof e[a]||eo(e[a])||(s=e[a],a++);const c={includeMetadataChanges:s.includeMetadataChanges};if(eo(e[a])){const t=e[a];e[a]=null===(n=t.next)||void 0===n?void 0:n.bind(t),e[a+1]=null===(r=t.error)||void 0===r?void 0:r.bind(t),e[a+2]=null===(i=t.complete)||void 0===i?void 0:i.bind(t)}let u,l,h;if(t instanceof Js)l=zs(t.firestore,no),h=Gt(t._key.path),u={next:n=>{e[a]&&e[a](aa(l,t,n))},error:e[a+1],complete:e[a+2]};else{const n=zs(t,Qs);l=zs(n.firestore,no),h=n._query;const r=new ea(l);u={next:t=>{e[a]&&e[a](new Fo(l,r,n,t))},error:e[a+1],complete:e[a+2]},Vo(t._query)}return function(t,e,n,r){const i=new ks(r),s=new Xi(e,i,n);return t.asyncQueue.enqueueAndForget(async()=>Hi(await Ds(t),s)),()=>{i.nc(),t.asyncQueue.enqueueAndForget(async()=>Ki(await Ds(t),s))}}(io(l),h,c,u)}function oa(t,e){return function(t,e){const n=new E;return t.asyncQueue.enqueueAndForget(async()=>as(await xs(t),e,n)),n.promise}(io(t),e)}function aa(t,e,n){const r=n.docs.get(e._key),i=new ea(t);return new Po(t,i,e._key,r,new Lo(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class zt{constructor(){this.providerId=zt.PROVIDER_ID}static credential(t,e){return Rt._fromEmailAndPassword(t,e)}static credentialWithLink(t,e){const n=Gt.parseLink(e);return v(n,"argument-error"),Rt._fromEmailAndCode(t,n.code,n.tenantId)}}zt.PROVIDER_ID="password",zt.EMAIL_PASSWORD_SIGN_IN_METHOD="password",zt.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function He(t,e){return L(t,"POST","/v2/accounts/mfaSignIn:start",D(t,e))}function Ke(t,e){return L(t,"POST","/v2/accounts/mfaSignIn:finalize",D(t,e))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.0c0cadfc.js.map